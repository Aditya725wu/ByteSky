...
router.get('/sessions', auth, asyncHandler(authController.getAuthSessions));
router.delete('/sessions/current', auth, asyncHandler(authController.revokeCurrentAuthSession));
router.delete('/sessions/:sessionId', auth, asyncHandler(authController.revokeAuthSession));
