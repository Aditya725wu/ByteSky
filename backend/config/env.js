...
const env = {
  ...
  marketplaceUrlMode: process.env.MARKETPLACE_URL_MODE || 'auto',
  marketplaceBindHost: process.env.MARKETPLACE_BIND_HOST || '0.0.0.0',
  apachePublicPath: process.env.APACHE_PUBLIC_PATH || '/apache/',
  jenkinsPublicPath: process.env.JENKINS_PUBLIC_PATH || '/jenkins/',
  metabasePublicPath: process.env.METABASE_PUBLIC_PATH || '/metabase/',
  vmPublicPath: process.env.VM_PUBLIC_PATH || '/vm/',
  ...
  apacheHostPort: parseNumber(process.env.APACHE_HOST_PORT, 8080),
  ...
  jenkinsInternalUrl: process.env.JENKINS_INTERNAL_URL || process.env.JENKINS_URL || '',
  jenkinsPublicUrl: process.env.JENKINS_PUBLIC_URL || '',
  ...
  jenkinsOpts: process.env.JENKINS_OPTS || '',
